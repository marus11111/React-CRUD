...
export default (type, options) => {
  return dispatch => {
    ...
    //set url depending on type of request and whether there are additional options
            ...
            case 'removePost':
              {
                ...
                from === 'list' ?
                dispatch(blogListRemoveError(res.error, id)) : dispatch(variousErrors(res.error));
                break;
              }
            case 'removeImage':
