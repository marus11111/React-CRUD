...
class Menu extends Component {
  constructor(props) {
    ...
    //number of menu items change depending on active ruote, 
    //so for proper positioning it's being hidden everytime route changes
  ...
  render() {
    ...
    //set menu items dpending on route and authorized user
    let menuItems = []
